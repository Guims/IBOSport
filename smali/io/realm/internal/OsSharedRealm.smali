...
.field public final context:Lio/realm/internal/g;
...
.method public constructor <init>(JLio/realm/internal/OsRealmConfig;)V
    ...
    iget-object v0, p3, Lio/realm/internal/OsRealmConfig;->u:Lio/realm/internal/g;

    invoke-direct {p0, p1, p2, p3, v0}, Lio/realm/internal/OsSharedRealm;-><init>(JLio/realm/internal/OsRealmConfig;Lio/realm/internal/g;)V
    ...
    iget-object v0, p2, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/g;

    iget-object v1, p3, Lio/realm/internal/OsRealmConfig;->u:Lio/realm/internal/g;
...
.method public constructor <init>(JLio/realm/internal/OsRealmConfig;Lio/realm/internal/g;)V
    .locals 2
    ...
    iput-object p4, p0, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/g;

    invoke-virtual {p4, p0}, Lio/realm/internal/g;->a(Lio/realm/internal/h;)V

    new-instance p3, LB0/i;

    const/4 p4, 0x5

    invoke-direct {p3, p4}, LB0/i;-><init>(I)V
...
.method private constructor <init>(Lio/realm/internal/OsRealmConfig;Lio/realm/internal/t;)V
    .locals 11
    ...
    invoke-direct {v1, v2}, LB0/i;-><init>(I)V
    ...
    iget-object v2, p1, Lio/realm/internal/OsRealmConfig;->u:Lio/realm/internal/g;

    iput-object v2, p0, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/g;
    ...
    :try_start_0
    iget-wide v3, p1, Lio/realm/internal/OsRealmConfig;->t:J

    iget-wide v5, p2, Lio/realm/internal/t;->b:J

    iget-wide v7, p2, Lio/realm/internal/t;->q:J
    ...
    invoke-direct {p1, v5, v6}, Lio/realm/internal/OsSchemaInfo;-><init>(J)V

    iput-object p1, p0, Lio/realm/internal/OsSharedRealm;->schemaInfo:Lio/realm/internal/OsSchemaInfo;

    invoke-virtual {v2, p0}, Lio/realm/internal/g;->a(Lio/realm/internal/h;)V
    ...
    sget-object p1, Lio/realm/internal/t;->r:Lio/realm/internal/t;

    invoke-virtual {p2, p1}, Lio/realm/internal/t;->equals(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, v1, LB0/i;->b:Ljava/lang/Object;

    check-cast p1, Landroid/os/Looper;

    if-eqz p1, :cond_0

    iget-boolean p1, v1, LB0/i;->a:Z
    ...
    :goto_0
    invoke-static {v3, v4, p1}, Lio/realm/internal/OsSharedRealm;->nativeSetAutoRefresh(JZ)V
...
.method private detachIterators()V
    ...
    check-cast v1, Lio/realm/internal/s;

    if-eqz v1, :cond_0

    iget-object v2, v1, Lio/realm/internal/s;->b:Lio/realm/internal/OsResults;

    invoke-virtual {v2}, Lio/realm/internal/OsResults;->c()Lio/realm/internal/OsResults;

    move-result-object v2

    iput-object v2, v1, Lio/realm/internal/s;->b:Lio/realm/internal/OsResults;
...
.method public static getInstance(Lio/realm/J;Lio/realm/internal/t;)Lio/realm/internal/OsSharedRealm;
    .locals 1

    new-instance v0, Lio/realm/internal/r;

    invoke-direct {v0, p0}, Lio/realm/internal/r;-><init>(Lio/realm/J;)V

    invoke-static {v0, p1}, Lio/realm/internal/OsSharedRealm;->getInstance(Lio/realm/internal/r;Lio/realm/internal/t;)Lio/realm/internal/OsSharedRealm;
...
.method public static getInstance(Lio/realm/internal/r;Lio/realm/internal/t;)Lio/realm/internal/OsSharedRealm;
    .locals 6
    ...
    iget-object v1, p0, Lio/realm/internal/r;->a:Lio/realm/J;

    iget-object v2, p0, Lio/realm/internal/r;->d:Ljava/lang/String;

    iget-boolean v3, p0, Lio/realm/internal/r;->c:Z

    iget-object v4, p0, Lio/realm/internal/r;->b:Lio/realm/internal/OsSchemaInfo;

    const/4 v5, 0x0

    invoke-direct/range {v0 .. v5}, Lio/realm/internal/OsRealmConfig;-><init>(Lio/realm/J;Ljava/lang/String;ZLio/realm/internal/OsSchemaInfo;Lio/realm/b;)V
    ...
    invoke-direct {p0, v0, p1}, Lio/realm/internal/OsSharedRealm;-><init>(Lio/realm/internal/OsRealmConfig;Lio/realm/internal/t;)V
...
.method private static runMigrationCallback(JLio/realm/internal/OsRealmConfig;Lio/realm/internal/OsSharedRealm$MigrationCallback;J)V
    ...
    iget-object p0, p2, Lio/realm/internal/OsRealmConfig;->r:Lio/realm/J;

    iget-wide v0, p0, Lio/realm/J;->d:J
...
# virtual methods
.method public addIterator(Lio/realm/internal/s;)V
    .locals 2
...
.method public addPendingRow(Lio/realm/internal/u;)V
    .locals 2
...
.method public close()V
    ...
    :cond_0
    iget-object v0, p0, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/g;
...
.method public freeze()Lio/realm/internal/OsSharedRealm;
    ...
    invoke-virtual {p0}, Lio/realm/internal/OsSharedRealm;->getVersionID()Lio/realm/internal/t;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lio/realm/internal/OsSharedRealm;-><init>(Lio/realm/internal/OsRealmConfig;Lio/realm/internal/t;)V

    return-object v0
.end method

.method public getConfiguration()Lio/realm/J;
    .locals 1

    iget-object v0, p0, Lio/realm/internal/OsSharedRealm;->osRealmConfig:Lio/realm/internal/OsRealmConfig;

    iget-object v0, v0, Lio/realm/internal/OsRealmConfig;->r:Lio/realm/J;
...
.method public getVersionID()Lio/realm/internal/t;
    .locals 6
    ...
    new-instance v1, Lio/realm/internal/t;
    ...
    invoke-direct {v1, v2, v3, v4, v5}, Lio/realm/internal/t;-><init>(JJ)V
...
.method public isSyncRealm()Z
    ...
    iget-object v0, v0, Lio/realm/internal/OsRealmConfig;->s:Ljava/net/URI;
...
.method public removePendingRow(Lio/realm/internal/u;)V
    .locals 2

    iget-object p1, p0, Lio/realm/internal/OsSharedRealm;->pendingRows:Ljava/util/List;
    ...
    iget-object v1, p0, Lio/realm/internal/OsSharedRealm;->pendingRows:Ljava/util/List;

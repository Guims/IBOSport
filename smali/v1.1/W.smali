...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lv1/W;->v:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->V0:LS/d;

    iput-object v0, p0, Lv1/W;->s:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lv1/W;->t:Z

    iput-boolean v1, p0, Lv1/W;->u:Z
    ...
    iput-object v1, p0, Lv1/W;->r:Landroid/widget/OverScroller;
...
.method public final a(II)V
    ...
    iget-object v1, p0, Lv1/W;->v:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/RecyclerView;->setScrollState(I)V

    const/4 v0, 0x0

    iput v0, p0, Lv1/W;->q:I

    iput v0, p0, Lv1/W;->b:I

    iget-object v0, p0, Lv1/W;->s:Landroid/view/animation/Interpolator;

    sget-object v2, Landroidx/recyclerview/widget/RecyclerView;->V0:LS/d;

    if-eq v0, v2, :cond_0

    iput-object v2, p0, Lv1/W;->s:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, p0, Lv1/W;->r:Landroid/widget/OverScroller;

    :cond_0
    iget-object v3, p0, Lv1/W;->r:Landroid/widget/OverScroller;
...
.method public final b()V
    ...
    iget-boolean v0, p0, Lv1/W;->t:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lv1/W;->u:Z

    return-void

    :cond_0
    iget-object v0, p0, Lv1/W;->v:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final c(IIILandroid/view/animation/Interpolator;)V
    ...
    iget-object v2, p0, Lv1/W;->v:Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget-object p4, Landroidx/recyclerview/widget/RecyclerView;->V0:LS/d;

    :cond_4
    iget-object p3, p0, Lv1/W;->s:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_5

    iput-object p4, p0, Lv1/W;->s:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Lv1/W;->r:Landroid/widget/OverScroller;

    :cond_5
    iput v1, p0, Lv1/W;->q:I

    iput v1, p0, Lv1/W;->b:I
...
.method public final run()V
    ...
    iget-object v0, p0, Lv1/W;->r:Landroid/widget/OverScroller;
    ...
    iput-boolean v9, p0, Lv1/W;->u:Z

    const/4 v10, 0x1

    iput-boolean v10, p0, Lv1/W;->t:Z

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView;->n()V

    iget-object v11, p0, Lv1/W;->r:Landroid/widget/OverScroller;
    ...
    iget v3, p0, Lv1/W;->b:I

    sub-int v3, v1, v3

    iget v4, p0, Lv1/W;->q:I

    sub-int v4, v2, v4

    iput v1, p0, Lv1/W;->b:I

    iput v2, p0, Lv1/W;->q:I
    ...
    invoke-virtual {v0, v1, v2, v8}, Landroidx/recyclerview/widget/RecyclerView;->d0(II[I)V
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView;->C:Lv1/G;

    iget-object v5, v5, Lv1/G;->e:Lv1/s;

    if-eqz v5, :cond_5

    iget-boolean v6, v5, Lv1/s;->d:Z

    if-nez v6, :cond_5

    iget-boolean v6, v5, Lv1/s;->e:Z

    if-eqz v6, :cond_5

    iget-object v6, v0, Landroidx/recyclerview/widget/RecyclerView;->w0:Lv1/T;
    ...
    invoke-virtual {v5}, Lv1/s;->j()V

    goto :goto_0

    :cond_3
    iget v7, v5, Lv1/s;->a:I

    if-lt v7, v6, :cond_4

    sub-int/2addr v6, v10

    iput v6, v5, Lv1/s;->a:I

    invoke-virtual {v5, v3, v4}, Lv1/s;->g(II)V
    ...
    iget-object v6, v6, Lv1/G;->e:Lv1/s;

    if-eqz v6, :cond_10

    iget-boolean v6, v6, Lv1/s;->d:Z
    ...
    iget-object v3, v0, Landroidx/recyclerview/widget/RecyclerView;->u0:Lv1/m;

    if-eqz v3, :cond_1d

    invoke-virtual {v3, v0, v1, v2}, Lv1/m;->a(Landroidx/recyclerview/widget/RecyclerView;II)V

    :cond_1d
    :goto_b
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->C:Lv1/G;

    iget-object v1, v1, Lv1/G;->e:Lv1/s;

    if-eqz v1, :cond_1e

    iget-boolean v2, v1, Lv1/s;->d:Z

    if-eqz v2, :cond_1e

    invoke-virtual {v1, v9, v9}, Lv1/s;->g(II)V

    :cond_1e
    iput-boolean v9, p0, Lv1/W;->t:Z

    iget-boolean v1, p0, Lv1/W;->u:Z

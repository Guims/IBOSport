...
.method static constructor <clinit>()V
    ...
    sput-object v0, LK5/d;->h:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    sput-object v0, LK5/d;->i:Ljava/util/concurrent/locks/Condition;
...
.method public final h()V
    ...
    :cond_0
    sget-object v4, LK5/d;->h:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v4}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-boolean v5, p0, LK5/d;->e:Z

    if-nez v5, :cond_8

    const/4 v5, 0x1

    iput-boolean v5, p0, LK5/d;->e:Z

    sget-object v6, LK5/d;->l:LK5/d;
    ...
    sput-object v6, LK5/d;->l:LK5/d;

    new-instance v6, LE2/f;

    const-string v7, "Okio Watchdog"

    invoke-direct {v6, v7}, LE2/f;-><init>(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object v3, v2, LK5/d;->f:LK5/d;

    if-eqz v3, :cond_5

    iget-wide v7, v3, LK5/d;->g:J
    ...
    :cond_5
    :goto_3
    iput-object v3, p0, LK5/d;->f:LK5/d;

    iput-object p0, v2, LK5/d;->f:LK5/d;
...
.method public final i()Z
    ...
    iget-object v3, v1, LK5/d;->f:LK5/d;

    if-ne v3, p0, :cond_1

    iget-object v3, p0, LK5/d;->f:LK5/d;

    iput-object v3, v1, LK5/d;->f:LK5/d;

    const/4 v1, 0x0

    iput-object v1, p0, LK5/d;->f:LK5/d;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

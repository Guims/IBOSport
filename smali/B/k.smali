...
.method public constructor <init>()V
    ...
    invoke-static {v1}, LB/k;->X(Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    invoke-virtual {p0, v1}, LB/k;->Y(Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    :goto_1
    iput-object v0, p0, LB/k;->h:Ljava/lang/Class;

    iput-object v2, p0, LB/k;->i:Ljava/lang/reflect/Constructor;

    iput-object v3, p0, LB/k;->j:Ljava/lang/reflect/Method;

    iput-object v4, p0, LB/k;->k:Ljava/lang/reflect/Method;

    iput-object v5, p0, LB/k;->l:Ljava/lang/reflect/Method;

    iput-object v6, p0, LB/k;->m:Ljava/lang/reflect/Method;

    iput-object v1, p0, LB/k;->n:Ljava/lang/reflect/Method;
...
.method public final U(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;III[Landroid/graphics/fonts/FontVariationAxis;)Z
    ...
    :try_start_0
    iget-object v1, p0, LB/k;->j:Ljava/lang/reflect/Method;
...
.method public V(Ljava/lang/Object;)Landroid/graphics/Typeface;
    ...
    :try_start_0
    iget-object v2, p0, LB/k;->h:Ljava/lang/Class;
    ...
    iget-object p1, p0, LB/k;->n:Ljava/lang/reflect/Method;
...
.method public final W(Ljava/lang/Object;)Z
    ...
    :try_start_0
    iget-object v0, p0, LB/k;->l:Ljava/lang/reflect/Method;
...
.method public final g(Landroid/content/Context;LA/g;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    .locals 9
    ...
    :try_start_0
    iget-object p4, p0, LB/k;->i:Ljava/lang/reflect/Constructor;
    ...
    iget-object v0, v0, LA/h;->d:Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v7}, LB/k;->U(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;III[Landroid/graphics/fonts/FontVariationAxis;)Z
    ...
    :try_start_1
    iget-object p1, v0, LB/k;->m:Ljava/lang/reflect/Method;
    ...
    invoke-virtual {p0, v2}, LB/k;->W(Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-virtual {p0, v2}, LB/k;->V(Ljava/lang/Object;)Landroid/graphics/Typeface;
    ...
    invoke-super {p0, v1, p2, p3, p4}, LB/i;->g(Landroid/content/Context;LA/g;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
...
.method public final h(Landroid/content/Context;[LG/h;I)Landroid/graphics/Typeface;
    .locals 12
    ...
    :cond_2
    iget-object v6, v6, LG/h;->a:Landroid/net/Uri;
    ...
    :cond_3
    invoke-static {p1, v6}, LE5/d;->y(Landroid/content/Context;Landroid/net/Uri;)Ljava/nio/MappedByteBuffer;
    ...
    :try_start_0
    iget-object v0, p0, LB/k;->i:Ljava/lang/reflect/Constructor;
    ...
    :goto_3
    iget-object v7, p0, LB/k;->m:Ljava/lang/reflect/Method;

    if-ge v5, v3, :cond_8

    aget-object v8, p2, v5

    iget-object v9, v8, LG/h;->a:Landroid/net/Uri;
    ...
    iget v10, v8, LG/h;->c:I

    iget-boolean v8, v8, LG/h;->d:Z

    :try_start_1
    iget-object v11, p0, LB/k;->k:Ljava/lang/reflect/Method;
    ...
    :cond_9
    invoke-virtual {p0, v0}, LB/k;->W(Ljava/lang/Object;)Z
    ...
    :cond_a
    invoke-virtual {p0, v0}, LB/k;->V(Ljava/lang/Object;)Landroid/graphics/Typeface;
    ...
    :cond_c
    invoke-virtual {p0, p3, p2}, LE2/g;->m(I[LG/h;)LG/h;
    ...
    :try_start_3
    iget-object p3, p2, LG/h;->a:Landroid/net/Uri;
...
.method public final j(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    iget-object p3, p0, LB/k;->i:Ljava/lang/reflect/Constructor;
    ...
    invoke-super/range {v3 .. v8}, LE2/g;->j(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;

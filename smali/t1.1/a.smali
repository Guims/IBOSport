...
.method public constructor <init>(Landroid/content/res/AssetManager;Ljava/util/concurrent/Executor;Lt1/c;Ljava/lang/String;Ljava/io/File;)V
    ...
    :pswitch_0
    sget-object p1, Lt1/d;->e:[B

    goto :goto_0

    :pswitch_1
    sget-object p1, Lt1/d;->f:[B

    goto :goto_0

    :pswitch_2
    sget-object p1, Lt1/d;->g:[B

    goto :goto_0

    :pswitch_3
    sget-object p1, Lt1/d;->h:[B

    :goto_0
    iput-object p1, p0, Lt1/a;->c:[B
...
.method public final b(ILjava/io/Serializable;)V
    ...
    invoke-direct {v0, p0, p1, p2, v1}, LA4/a;-><init>(Ljava/lang/Object;ILjava/lang/Object;I)V

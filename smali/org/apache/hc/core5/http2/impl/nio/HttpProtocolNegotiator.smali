.class public Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;
...
.field private final negotiatedProtocolRef:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public constructor <init>(Lorg/apache/hc/core5/reactor/ProtocolIOSession;Lorg/apache/hc/core5/concurrent/FutureCallback;)V
    ...
    iput-object p1, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->ioSession:Lorg/apache/hc/core5/reactor/ProtocolIOSession;

    iput-object p2, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->resultCallback:Lorg/apache/hc/core5/concurrent/FutureCallback;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object p1, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->completed:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->negotiatedProtocolRef:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public close()V
    ...
    iget-object v0, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->ioSession:Lorg/apache/hc/core5/reactor/ProtocolIOSession;
...
.method public connected(Lorg/apache/hc/core5/reactor/IOSession;)V
    ...
    iget-object p1, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->ioSession:Lorg/apache/hc/core5/reactor/ProtocolIOSession;
    ...
    invoke-static {p1}, Lorg/apache/hc/core5/util/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    const-string v1, "Unsupported application protocol: "

    invoke-virtual {v1, p1}, Ljava/lang/String;->concat(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {v0, p1}, Lorg/apache/hc/core5/http2/impl/nio/ProtocolNegotiationException;-><init>(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->startProtocol(Lorg/apache/hc/core5/http/HttpVersion;)V
...
.method public disconnected(Lorg/apache/hc/core5/reactor/IOSession;)V
    ...
    iget-object p1, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->completed:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p1, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->resultCallback:Lorg/apache/hc/core5/concurrent/FutureCallback;
    ...
    iget-object v2, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->completed:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->resultCallback:Lorg/apache/hc/core5/concurrent/FutureCallback;
...
.method public exception(Lorg/apache/hc/core5/reactor/IOSession;Ljava/lang/Exception;)V
    ...
    iget-object p2, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->completed:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p2, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->resultCallback:Lorg/apache/hc/core5/concurrent/FutureCallback;
...
.method public getProtocolVersion()Lorg/apache/hc/core5/http/ProtocolVersion;
    ...
    iget-object v0, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->negotiatedProtocolRef:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lorg/apache/hc/core5/http/ProtocolVersion;
...
.method public startProtocol(Lorg/apache/hc/core5/http/HttpVersion;)V
    .locals 3
    ...
    :cond_0
    sget-object v1, Lorg/apache/hc/core5/http2/ssl/ApplicationProtocol;->HTTP_1_1:Lorg/apache/hc/core5/http2/ssl/ApplicationProtocol;

    goto :goto_0

    :goto_1
    iget-object v2, p0, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->resultCallback:Lorg/apache/hc/core5/concurrent/FutureCallback;

    invoke-interface {v0, v1, v2}, Lorg/apache/hc/core5/reactor/ProtocolIOSession;->switchProtocol(Ljava/lang/String;Lorg/apache/hc/core5/concurrent/FutureCallback;)V
...
.method public timeout(Lorg/apache/hc/core5/reactor/IOSession;Lorg/apache/hc/core5/util/Timeout;)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/hc/core5/http2/impl/nio/HttpProtocolNegotiator;->exception(Lorg/apache/hc/core5/reactor/IOSession;Ljava/lang/Exception;)V

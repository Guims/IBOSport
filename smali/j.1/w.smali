...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lj/m;Landroid/view/View;ZII)V
    .locals 0
    ...
    new-instance p6, Lj/v;

    invoke-direct {p6, p0}, Lj/v;-><init>(Lj/w;)V

    iput-object p6, p0, Lj/w;->k:Lj/v;
...
.method public final a()Lj/u;
    ...
    iget-object v6, p0, Lj/w;->a:Landroid/content/Context;

    iget-object v7, p0, Lj/w;->b:Lj/m;

    invoke-direct/range {v5 .. v10}, Lj/D;-><init>(Landroid/content/Context;Lj/m;Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, v1}, Lj/u;->l(Lj/m;)V

    iget-object v1, p0, Lj/w;->k:Lj/v;

    invoke-virtual {v0, v1}, Lj/u;->r(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Lj/w;->e:Landroid/view/View;

    invoke-virtual {v0, v1}, Lj/u;->n(Landroid/view/View;)V

    iget-object v1, p0, Lj/w;->h:Lj/x;

    invoke-interface {v0, v1}, Lj/y;->e(Lj/x;)V

    iget-boolean v1, p0, Lj/w;->g:Z

    invoke-virtual {v0, v1}, Lj/u;->o(Z)V

    iget v1, p0, Lj/w;->f:I

    invoke-virtual {v0, v1}, Lj/u;->p(I)V
...
.method public c()V
    ...
    iget-object v0, p0, Lj/w;->j:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public final d(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Lj/u;->s(Z)V
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lj/u;->q(I)V

    invoke-virtual {v0, p2}, Lj/u;->t(I)V
    ...
    iput-object p4, v0, Lj/u;->b:Landroid/graphics/Rect;

    :cond_1
    invoke-interface {v0}, Lj/C;->g()V

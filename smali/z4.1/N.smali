...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lz4/N;->E0:Lib/player/models/WordModels;

    const/4 v0, 0x0

    iput v0, p0, Lz4/N;->F0:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lz4/N;->H0:Z

    return-void
.end method

.method public static T(Landroid/content/Context;Ljava/util/ArrayList;IZLz4/M;)Lz4/N;
    .locals 1
    ...
    iput-object p0, v0, Lz4/N;->C0:Landroid/content/Context;

    iput-object p1, v0, Lz4/N;->z0:Ljava/util/ArrayList;

    iput p2, v0, Lz4/N;->F0:I

    iput-object p4, v0, Lz4/N;->G0:Lz4/M;

    iput-boolean p3, v0, Lz4/N;->H0:Z
...
.method public final w(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p2, p0, Lz4/N;->C0:Landroid/content/Context;

    invoke-static {p2}, Lib/player/base/helper/d;->j(Landroid/content/Context;)Lib/player/models/WordModels;

    move-result-object p2

    iput-object p2, p0, Lz4/N;->E0:Lib/player/models/WordModels;
    ...
    iput-object p2, p0, Lz4/N;->B0:Landroidx/recyclerview/widget/RecyclerView;

    iget-object p2, p0, Lz4/N;->A0:Landroid/widget/TextView;

    iget-boolean v0, p0, Lz4/N;->H0:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lz4/N;->E0:Lib/player/models/WordModels;

    invoke-virtual {v0}, Lib/player/models/WordModels;->getSubtitle()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lib/player/models/WordModels;->getAudio_track()Ljava/lang/String;
    ...
    iget-object v0, p0, Lz4/N;->z0:Ljava/util/ArrayList;

    iget v1, p0, Lz4/N;->F0:I
    ...
    iput-object p2, p0, Lz4/N;->D0:Ls4/o;

    iget-object p2, p0, Lz4/N;->B0:Landroidx/recyclerview/widget/RecyclerView;

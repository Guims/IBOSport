...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lk/k;->s:Landroid/view/LayoutInflater;
    ...
    iput-object p1, p0, Lk/k;->G:Landroid/util/SparseBooleanArray;
    ...
    iput-object p1, p0, Lk/k;->L:Lcom/bumptech/glide/f;
...
# virtual methods
.method public final a(Lj/o;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3
    ...
    :cond_1
    iget-object p2, p0, Lk/k;->s:Landroid/view/LayoutInflater;
...
.method public final c()Z
    ...
    iget-object v2, v0, Lk/k;->G:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {v0, v10, v12, v8}, Lk/k;->a(Lj/o;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_9
    invoke-virtual {v10, v14}, Lj/o;->f(Z)V
    ...
    invoke-virtual {v0, v10, v13, v8}, Lk/k;->a(Lj/o;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v14, v0}, Lj/o;->f(Z)V
    ...
    :cond_14
    invoke-virtual {v10, v12}, Lj/o;->f(Z)V
    ...
    invoke-virtual {v10, v0}, Lj/o;->f(Z)V
...
.method public final d(Lj/m;Z)V
    ...
    invoke-virtual {p0}, Lk/k;->g()Z

    iget-object v0, p0, Lk/k;->I:Lk/g;
...
.method public final f(Lj/E;)Z
    ...
    :cond_1
    iget-object v0, v0, Lj/E;->A:Lj/o;

    iget-object v2, p0, Lk/k;->w:Lj/A;
...
.method public final g()Z
    ...
    iput-object v0, p0, Lk/k;->J:Lk/i;

    return v1

    :cond_0
    iget-object v0, p0, Lk/k;->H:Lk/g;
...
.method public final h()V
    ...
    :goto_1
    invoke-virtual {p0, v7, v8, v0}, Lk/k;->a(Lj/o;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v1, p0, Lk/k;->w:Lj/A;

    if-eq v0, v1, :cond_11

    if-eqz v0, :cond_f

    iget-object v1, p0, Lk/k;->x:Lk/j;
...
.method public final j(Landroid/content/Context;Lj/m;)V
    ...
    iput-object p1, p0, Lk/k;->q:Landroid/content/Context;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    iput-object p2, p0, Lk/k;->r:Lj/m;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p2

    iget-boolean v0, p0, Lk/k;->B:Z
    ...
    iget-object v2, p0, Lk/k;->b:Landroid/content/Context;

    invoke-direct {v0, p0, v2}, Lk/j;-><init>(Lk/k;Landroid/content/Context;)V

    iput-object v0, p0, Lk/k;->x:Lk/j;

    iget-boolean v2, p0, Lk/k;->z:Z

    const/4 v3, 0x0

    if-eqz v2, :cond_8

    iget-object v2, p0, Lk/k;->y:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v2}, Lk/w;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v1, p0, Lk/k;->y:Landroid/graphics/drawable/Drawable;

    iput-boolean v3, p0, Lk/k;->z:Z
...
.method public final l()Z
    ...
    iget-object v1, p0, Lk/k;->q:Landroid/content/Context;

    iget-object v2, p0, Lk/k;->r:Lj/m;

    iget-object v3, p0, Lk/k;->x:Lk/j;

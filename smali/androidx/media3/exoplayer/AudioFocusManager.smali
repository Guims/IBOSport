...
.field private final audioManager:Lo3/h;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Landroidx/media3/exoplayer/AudioFocusManager$PlayerControl;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/AudioFocusManager;->audioManager:Lo3/h;
...
.method private abandonAudioFocusDefault()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/AudioFocusManager;->audioManager:Lo3/h;
...
.method private abandonAudioFocusV26()V
    ...
    invoke-static {v0, v1}, LW3/h;->A(Landroid/media/AudioManager;Landroid/media/AudioFocusRequest;)V
...
.method private handlePlatformAudioFocusChange(I)V
    ...
    invoke-static {v1, p1, v0}, Lcom/google/android/material/datepicker/e;->m(Ljava/lang/String;ILjava/lang/String;)V
...
.method private static lambda$new$0(Landroid/content/Context;)Landroid/media/AudioManager;
    .locals 1
...
.method private requestAudioFocusV26()I
    ...
    invoke-static {}, LW3/h;->w()V

    iget v0, p0, Landroidx/media3/exoplayer/AudioFocusManager;->focusGainToRequest:I

    invoke-static {v0}, LW3/h;->g(I)Landroid/media/AudioFocusRequest$Builder;
    ...
    invoke-static {v0}, LW3/h;->k(Landroid/media/AudioFocusRequest;)Landroid/media/AudioFocusRequest$Builder;
    ...
    invoke-static {v0, v2}, LW3/h;->h(Landroid/media/AudioFocusRequest$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioFocusRequest$Builder;

    move-result-object v0

    invoke-static {v0, v1}, LW3/h;->j(Landroid/media/AudioFocusRequest$Builder;Z)Landroid/media/AudioFocusRequest$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/media3/exoplayer/AudioFocusManager;->focusListener:Landroidx/media3/exoplayer/AudioFocusManager$AudioFocusListener;

    invoke-static {v0, v1}, LW3/h;->i(Landroid/media/AudioFocusRequest$Builder;Landroid/media/AudioManager$OnAudioFocusChangeListener;)Landroid/media/AudioFocusRequest$Builder;

    move-result-object v0

    invoke-static {v0}, LW3/h;->l(Landroid/media/AudioFocusRequest$Builder;)Landroid/media/AudioFocusRequest;
    ...
    invoke-static {v0, v1}, LW3/h;->b(Landroid/media/AudioManager;Landroid/media/AudioFocusRequest;)I
...
.method public setAudioAttributes(Landroidx/media3/common/AudioAttributes;)V
    ...
    invoke-static {p1, v0}, Lk0/c;->c(Ljava/lang/String;Z)V

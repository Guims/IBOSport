...
# instance fields
.field private final allocator:LE0/f;
...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v9}, Landroidx/media3/exoplayer/DefaultLoadControl;-><init>(LE0/f;IIIIIZIZ)V

    return-void
.end method

.method public constructor <init>(LE0/f;IIIIIZIZ)V
    .locals 5
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/DefaultLoadControl;->allocator:LE0/f;
...
.method private static assertGreaterOrEqual(IILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p0}, Lk0/c;->c(Ljava/lang/String;Z)V
...
.method private removePlayer(Lq0/q;)V
    .locals 1
...
.method private resetPlayerLoadingState(Lq0/q;)V
    .locals 2
...
.method private updateAllocator()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/DefaultLoadControl;->allocator:LE0/f;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, v0, LE0/f;->a:Z

    if-eqz v1, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LE0/f;->a(I)V
    :try_end_0
...
# virtual methods
.method public calculateTargetBufferBytes([LD0/v;)I
    .locals 4
...
.method public final calculateTargetBufferBytes([Landroidx/media3/exoplayer/Renderer;[LD0/v;)I
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    invoke-virtual {p0, p2}, Landroidx/media3/exoplayer/DefaultLoadControl;->calculateTargetBufferBytes([LD0/v;)I
...
.method public getBackBufferDurationUs(Lq0/q;)J
    .locals 2
...
.method public onPrepared(Lq0/q;)V
    .locals 6
    ...
    invoke-static {v3, v2}, Lk0/c;->i(Ljava/lang/String;Z)V
    ...
    :cond_2
    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/DefaultLoadControl;->resetPlayerLoadingState(Lq0/q;)V

    return-void
.end method

.method public onReleased(Lq0/q;)V
    .locals 2

    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/DefaultLoadControl;->removePlayer(Lq0/q;)V
...
.method public onStopped(Lq0/q;)V
    .locals 0
...
.method public onTracksSelected(Landroidx/media3/exoplayer/LoadControl$Parameters;Landroidx/media3/exoplayer/source/t0;[LD0/v;)V
    .locals 1

    iget-object p2, p0, Landroidx/media3/exoplayer/DefaultLoadControl;->loadingStates:Ljava/util/HashMap;

    iget-object p1, p1, Landroidx/media3/exoplayer/LoadControl$Parameters;->playerId:Lq0/q;
    ...
    invoke-virtual {p0, p3}, Landroidx/media3/exoplayer/DefaultLoadControl;->calculateTargetBufferBytes([LD0/v;)I
...
.method public retainBackBufferFromKeyframe(Lq0/q;)Z
    .locals 0
...
.method public shouldContinueLoading(Landroidx/media3/exoplayer/LoadControl$Parameters;)Z
    ...
    iget-object v1, p1, Landroidx/media3/exoplayer/LoadControl$Parameters;->playerId:Lq0/q;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/DefaultLoadControl;->allocator:LE0/f;
    ...
    invoke-static {v5, v6, v2}, Lk0/C;->x(JF)J
    ...
    invoke-static {p1, v1}, Lk0/c;->z(Ljava/lang/String;Ljava/lang/String;)V
...
.method public shouldContinuePreloading(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;J)Z
    .locals 0
...
.method public shouldStartPlayback(Landroidx/media3/exoplayer/LoadControl$Parameters;)Z
    ...
    invoke-static {v0, v1, v2}, Lk0/C;->C(JF)J
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/DefaultLoadControl;->allocator:LE0/f;

    monitor-enter p1

    :try_start_0
    iget v0, p1, LE0/f;->d:I

    iget v1, p1, LE0/f;->b:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

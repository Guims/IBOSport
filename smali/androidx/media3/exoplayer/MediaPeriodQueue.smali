...
.field private final analyticsCollectorHandler:Lk0/l;
...
# direct methods
.method public constructor <init>(Lq0/a;Lk0/l;Landroidx/media3/exoplayer/MediaPeriodHolder$Factory;Landroidx/media3/exoplayer/ExoPlayer$PreloadConfiguration;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/MediaPeriodQueue;->analyticsCollector:Lq0/a;

    iput-object p2, p0, Landroidx/media3/exoplayer/MediaPeriodQueue;->analyticsCollectorHandler:Lk0/l;
...
.method public static synthetic a(Landroidx/media3/exoplayer/MediaPeriodQueue;Lp3/E;Landroidx/media3/exoplayer/source/E;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/MediaPeriodQueue;->lambda$notifyQueueUpdate$0(Lp3/E;Landroidx/media3/exoplayer/source/E;)V
...
.method private canKeepMediaPeriodHolder(Landroidx/media3/exoplayer/MediaPeriodInfo;Landroidx/media3/exoplayer/MediaPeriodInfo;)Z
    ...
    invoke-virtual {p1, p2}, Landroidx/media3/exoplayer/source/E;->equals(Ljava/lang/Object;)Z
...
.method private getFirstMediaPeriodInfo(Landroidx/media3/exoplayer/PlaybackInfo;)Landroidx/media3/exoplayer/MediaPeriodInfo;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/media3/exoplayer/MediaPeriodQueue;->getMediaPeriodInfo(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;JJ)Landroidx/media3/exoplayer/MediaPeriodInfo;
...
.method private getFirstMediaPeriodInfoOfNextPeriod(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/MediaPeriodHolder;J)Landroidx/media3/exoplayer/MediaPeriodInfo;
    ...
    iget-object v2, v10, Landroidx/media3/exoplayer/MediaPeriodInfo;->id:Landroidx/media3/exoplayer/source/E;
    ...
    iget-object v5, v10, Landroidx/media3/exoplayer/MediaPeriodInfo;->id:Landroidx/media3/exoplayer/source/E;

    iget-wide v5, v5, Landroidx/media3/exoplayer/source/E;->d:J
    ...
    iget-wide v5, v1, Landroidx/media3/exoplayer/source/E;->d:J
    ...
    invoke-static/range {v1 .. v8}, Landroidx/media3/exoplayer/MediaPeriodQueue;->resolveMediaPeriodIdForAds(Landroidx/media3/common/Timeline;Ljava/lang/Object;JJLandroidx/media3/common/Timeline$Window;Landroidx/media3/common/Timeline$Period;)Landroidx/media3/exoplayer/source/E;
...
.method private getFollowingMediaPeriodInfoOfCurrentPeriod(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/MediaPeriodHolder;J)Landroidx/media3/exoplayer/MediaPeriodInfo;
    ...
    iget-object v9, v8, Landroidx/media3/exoplayer/MediaPeriodInfo;->id:Landroidx/media3/exoplayer/source/E;

    iget-object v3, v9, Landroidx/media3/exoplayer/source/E;->a:Ljava/lang/Object;

    iget-object v10, v9, Landroidx/media3/exoplayer/source/E;->a:Ljava/lang/Object;

    iget v4, v9, Landroidx/media3/exoplayer/source/E;->e:I

    iget-object v5, p0, Landroidx/media3/exoplayer/MediaPeriodQueue;->period:Landroidx/media3/common/Timeline$Period;

    invoke-virtual {p1, v3, v5}, Landroidx/media3/common/Timeline;->getPeriodByUid(Ljava/lang/Object;Landroidx/media3/common/Timeline$Period;)Landroidx/media3/common/Timeline$Period;
    ...
    iget v3, v9, Landroidx/media3/exoplayer/source/E;->b:I
    ...
    iget v5, v9, Landroidx/media3/exoplayer/source/E;->c:I
    ...
    iget-wide v7, v9, Landroidx/media3/exoplayer/source/E;->d:J
    ...
    invoke-direct {p0, p1, v10, v3}, Landroidx/media3/exoplayer/MediaPeriodQueue;->getMinStartPositionAfterAdGroupUs(Landroidx/media3/common/Timeline;Ljava/lang/Object;I)J
    ...
    invoke-virtual {v1, v4}, Landroidx/media3/common/Timeline$Period;->isLivePostrollPlaceholder(I)Z
    ...
    invoke-virtual {v1, v4}, Landroidx/media3/common/Timeline$Period;->getFirstAdIndexToPlay(I)I

    move-result v1

    iget-object v2, p0, Landroidx/media3/exoplayer/MediaPeriodQueue;->period:Landroidx/media3/common/Timeline$Period;

    invoke-virtual {v2, v4}, Landroidx/media3/common/Timeline$Period;->isServerSideInsertedAdGroup(I)Z
    ...
    invoke-virtual {v2, v4, v1}, Landroidx/media3/common/Timeline$Period;->getAdState(II)I
    ...
    invoke-virtual {v3, v4}, Landroidx/media3/common/Timeline$Period;->getAdCountInAdGroup(I)I
    ...
    iget v3, v9, Landroidx/media3/exoplayer/source/E;->e:I
    ...
    :cond_8
    :goto_1
    invoke-direct {p0, p1, v10, v4}, Landroidx/media3/exoplayer/MediaPeriodQueue;->getMinStartPositionAfterAdGroupUs(Landroidx/media3/common/Timeline;Ljava/lang/Object;I)J
...
.method private getMediaPeriodInfo(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;JJ)Landroidx/media3/exoplayer/MediaPeriodInfo;
    .locals 10
    ...
    iget-object v3, p2, Landroidx/media3/exoplayer/source/E;->a:Ljava/lang/Object;

    iget v4, p2, Landroidx/media3/exoplayer/source/E;->b:I

    iget v5, p2, Landroidx/media3/exoplayer/source/E;->c:I

    iget-wide v8, p2, Landroidx/media3/exoplayer/source/E;->d:J
    ...
    :cond_0
    iget-object v2, p2, Landroidx/media3/exoplayer/source/E;->a:Ljava/lang/Object;

    iget-wide v7, p2, Landroidx/media3/exoplayer/source/E;->d:J
...
.method private getMediaPeriodInfoForAd(Landroidx/media3/common/Timeline;Ljava/lang/Object;IIJJ)Landroidx/media3/exoplayer/MediaPeriodInfo;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/media3/exoplayer/source/E;-><init>(Ljava/lang/Object;IIJI)V

    iget-object v1, p0, Landroidx/media3/exoplayer/MediaPeriodQueue;->period:Landroidx/media3/common/Timeline$Period;

    move-object/from16 v4, p2

    invoke-virtual {p1, v4, v1}, Landroidx/media3/common/Timeline;->getPeriodByUid(Ljava/lang/Object;Landroidx/media3/common/Timeline$Period;)Landroidx/media3/common/Timeline$Period;

    move-result-object p1

    invoke-virtual {p1, v2, v3}, Landroidx/media3/common/Timeline$Period;->getAdDurationUs(II)J
    ...
    invoke-virtual {p1, v2}, Landroidx/media3/common/Timeline$Period;->isServerSideInsertedAdGroup(I)Z
    ...
    invoke-direct/range {v0 .. v13}, Landroidx/media3/exoplayer/MediaPeriodInfo;-><init>(Landroidx/media3/exoplayer/source/E;JJJJZZZZ)V
...
.method private getMediaPeriodInfoForContent(Landroidx/media3/common/Timeline;Ljava/lang/Object;JJJ)Landroidx/media3/exoplayer/MediaPeriodInfo;
    ...
    :goto_1
    new-instance v12, Landroidx/media3/exoplayer/source/E;

    move-wide/from16 v13, p7

    invoke-direct {v12, v5, v13, v14, v2}, Landroidx/media3/exoplayer/source/E;-><init>(IJLjava/lang/Object;)V

    invoke-direct {v0, v12}, Landroidx/media3/exoplayer/MediaPeriodQueue;->isLastInPeriod(Landroidx/media3/exoplayer/source/E;)Z

    move-result v2

    invoke-direct {v0, v1, v12}, Landroidx/media3/exoplayer/MediaPeriodQueue;->isLastInWindow(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;)Z

    move-result v23

    invoke-direct {v0, v1, v12, v2}, Landroidx/media3/exoplayer/MediaPeriodQueue;->isLastInTimeline(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;Z)Z
    ...
    invoke-direct/range {v11 .. v24}, Landroidx/media3/exoplayer/MediaPeriodInfo;-><init>(Landroidx/media3/exoplayer/source/E;JJJJZZZZ)V
...
.method private getMediaPeriodInfoForPeriodPosition(Landroidx/media3/common/Timeline;Ljava/lang/Object;JJ)Landroidx/media3/exoplayer/MediaPeriodInfo;
    ...
    invoke-static/range {v0 .. v7}, Landroidx/media3/exoplayer/MediaPeriodQueue;->resolveMediaPeriodIdForAds(Landroidx/media3/common/Timeline;Ljava/lang/Object;JJLandroidx/media3/common/Timeline$Window;Landroidx/media3/common/Timeline$Period;)Landroidx/media3/exoplayer/source/E;
    ...
    iget-object v2, p1, Landroidx/media3/exoplayer/source/E;->a:Ljava/lang/Object;

    move-wide v5, v3

    iget v3, p1, Landroidx/media3/exoplayer/source/E;->b:I

    iget v4, p1, Landroidx/media3/exoplayer/source/E;->c:I

    iget-wide v7, p1, Landroidx/media3/exoplayer/source/E;->d:J
...
.method private isLastInPeriod(Landroidx/media3/exoplayer/source/E;)Z
    .locals 1
    ...
    iget p1, p1, Landroidx/media3/exoplayer/source/E;->e:I
...
.method private isLastInTimeline(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;Z)Z
    .locals 6
...
.method private isLastInWindow(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;)Z
    .locals 3

    invoke-direct {p0, p2}, Landroidx/media3/exoplayer/MediaPeriodQueue;->isLastInPeriod(Landroidx/media3/exoplayer/source/E;)Z
...
.method private lambda$notifyQueueUpdate$0(Lp3/E;Landroidx/media3/exoplayer/source/E;)V
    .locals 3

    iget-object v0, p0, Landroidx/media3/exoplayer/MediaPeriodQueue;->analyticsCollector:Lq0/a;
    ...
    iget-object v0, v0, Lq0/j;->v:Landroidx/media3/common/Player;
    ...
    iput-object v2, v1, Lq0/i;->b:Lp3/H;
    ...
    invoke-virtual {p1, v2}, Lp3/Y;->get(I)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroidx/media3/exoplayer/source/E;

    iput-object p1, v1, Lq0/i;->e:Landroidx/media3/exoplayer/source/E;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p2, v1, Lq0/i;->f:Landroidx/media3/exoplayer/source/E;

    :cond_0
    iget-object p1, v1, Lq0/i;->d:Landroidx/media3/exoplayer/source/E;

    if-nez p1, :cond_1

    iget-object p1, v1, Lq0/i;->b:Lp3/H;

    iget-object p2, v1, Lq0/i;->e:Landroidx/media3/exoplayer/source/E;

    iget-object v2, v1, Lq0/i;->a:Landroidx/media3/common/Timeline$Period;

    invoke-static {v0, p1, p2, v2}, Lq0/i;->b(Landroidx/media3/common/Player;Lp3/H;Landroidx/media3/exoplayer/source/E;Landroidx/media3/common/Timeline$Period;)Landroidx/media3/exoplayer/source/E;

    move-result-object p1

    iput-object p1, v1, Lq0/i;->d:Landroidx/media3/exoplayer/source/E;
    ...
    invoke-virtual {v1, p1}, Lq0/i;->d(Landroidx/media3/common/Timeline;)V
...
.method private notifyQueueUpdate()V
    ...
    iget-object v2, v2, Landroidx/media3/exoplayer/MediaPeriodInfo;->id:Landroidx/media3/exoplayer/source/E;
    ...
    :goto_1
    iget-object v2, p0, Landroidx/media3/exoplayer/MediaPeriodQueue;->analyticsCollectorHandler:Lk0/l;

    new-instance v3, Landroidx/media3/exoplayer/y;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v0, v1, v4}, Landroidx/media3/exoplayer/y;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    check-cast v2, Lk0/y;

    invoke-virtual {v2, v3}, Lk0/y;->e(Ljava/lang/Runnable;)Z
...
.method private static resolveMediaPeriodIdForAds(Landroidx/media3/common/Timeline;Ljava/lang/Object;JJLandroidx/media3/common/Timeline$Window;Landroidx/media3/common/Timeline$Period;)Landroidx/media3/exoplayer/source/E;
    .locals 2
    ...
    new-instance p2, Landroidx/media3/exoplayer/source/E;

    invoke-direct {p2, p0, p4, p5, p1}, Landroidx/media3/exoplayer/source/E;-><init>(IJLjava/lang/Object;)V
    ...
    new-instance p0, Landroidx/media3/exoplayer/source/E;

    const/4 p6, -0x1

    invoke-direct/range {p0 .. p6}, Landroidx/media3/exoplayer/source/E;-><init>(Ljava/lang/Object;IIJI)V
...
.method private resolvePeriodUidToWindowSequenceNumberInPreloadPeriods(Ljava/lang/Object;)J
    ...
    iget-wide v0, p1, Landroidx/media3/exoplayer/source/E;->d:J
...
.method public getPreloadHolderByMediaPeriod(Landroidx/media3/exoplayer/source/C;)Landroidx/media3/exoplayer/MediaPeriodHolder;
    .locals 3
...
.method public getUpdatedMediaPeriodInfo(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/MediaPeriodInfo;)Landroidx/media3/exoplayer/MediaPeriodInfo;
    ...
    invoke-direct {v0, v3}, Landroidx/media3/exoplayer/MediaPeriodQueue;->isLastInPeriod(Landroidx/media3/exoplayer/source/E;)Z

    move-result v12

    invoke-direct {v0, v1, v3}, Landroidx/media3/exoplayer/MediaPeriodQueue;->isLastInWindow(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;)Z

    move-result v13

    invoke-direct {v0, v1, v3, v12}, Landroidx/media3/exoplayer/MediaPeriodQueue;->isLastInTimeline(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/E;Z)Z

    move-result v14

    iget-object v4, v2, Landroidx/media3/exoplayer/MediaPeriodInfo;->id:Landroidx/media3/exoplayer/source/E;
    ...
    iget v5, v3, Landroidx/media3/exoplayer/source/E;->e:I
    ...
    iget v6, v3, Landroidx/media3/exoplayer/source/E;->c:I

    invoke-virtual {v1, v4, v6}, Landroidx/media3/common/Timeline$Period;->getAdDurationUs(II)J
    ...
    invoke-direct/range {v1 .. v14}, Landroidx/media3/exoplayer/MediaPeriodInfo;-><init>(Landroidx/media3/exoplayer/source/E;JJJJZZZZ)V
...
.method public isLoading(Landroidx/media3/exoplayer/source/C;)Z
    .locals 1
...
.method public isPreloading(Landroidx/media3/exoplayer/source/C;)Z
    .locals 1
...
.method public resolveMediaPeriodIdForAds(Landroidx/media3/common/Timeline;Ljava/lang/Object;J)Landroidx/media3/exoplayer/source/E;
    .locals 8
...
.method public resolveMediaPeriodIdForAdsAfterPeriodPositionChange(Landroidx/media3/common/Timeline;Ljava/lang/Object;J)Landroidx/media3/exoplayer/source/E;
    .locals 10

...
.method public declared-synchronized onFailed(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    :cond_0
    :try_start_1
    invoke-static {p3}, Landroidx/media3/datasource/a;->x(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {p3}, Landroidx/media3/datasource/a;->f(Ljava/lang/Object;)Landroid/net/http/NetworkException;

    move-result-object p1

    invoke-static {p1}, Landroidx/media3/datasource/a;->a(Landroid/net/http/NetworkException;)I
    ...
    invoke-static {p1}, Landroidx/media3/datasource/HttpEngineDataSource;->access$300(Landroidx/media3/datasource/HttpEngineDataSource;)Lk0/g;
...
.method public declared-synchronized onRedirectReceived(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/lang/String;)V
    ...
    invoke-static {p2}, Landroidx/media3/datasource/a;->b(Landroid/net/http/UrlResponseInfo;)I
    ...
    invoke-static {p2}, Landroidx/media3/datasource/a;->m(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;

    move-result-object v3

    invoke-static {p2}, Landroidx/media3/datasource/a;->d(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p2

    invoke-static {p2}, Landroidx/media3/datasource/a;->o(Landroid/net/http/HeaderBlock;)Ljava/util/Map;

    move-result-object v5

    sget-object v7, Lk0/C;->f:[B
    ...
    invoke-static {p1}, Landroidx/media3/datasource/a;->t(Landroid/net/http/UrlRequest;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    :cond_6
    :try_start_4
    invoke-static {p1}, Landroidx/media3/datasource/a;->B(Landroid/net/http/UrlRequest;)V

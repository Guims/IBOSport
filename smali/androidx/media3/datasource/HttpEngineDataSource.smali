...
.field private contentTypePredicate:Lo3/e;
...
.field private final operation:Lk0/g;
...
# direct methods
.method public constructor <init>(Landroid/net/http/HttpEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Landroidx/media3/datasource/HttpDataSource$RequestProperties;Lo3/e;Z)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1}, Landroidx/media3/datasource/a;->e(Ljava/lang/Object;)Landroid/net/http/HttpEngine;
    ...
    iput-object p10, p0, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:Lo3/e;
    ...
    iput-object p1, p0, Landroidx/media3/datasource/HttpEngineDataSource;->clock:Lk0/d;
    ...
    iput-object p1, p0, Landroidx/media3/datasource/HttpEngineDataSource;->operation:Lk0/g;
...
.method public static synthetic access$300(Landroidx/media3/datasource/HttpEngineDataSource;)Lk0/g;
    .locals 0

    iget-object p0, p0, Landroidx/media3/datasource/HttpEngineDataSource;->operation:Lk0/g;
...
.method private blockUntilConnectTimeout()Z
    ...
    iget-object v0, p0, Landroidx/media3/datasource/HttpEngineDataSource;->clock:Lk0/d;
    ...
    iget-object v2, p0, Landroidx/media3/datasource/HttpEngineDataSource;->operation:Lk0/g;
...
.method private buildRequestBuilder(Landroidx/media3/datasource/DataSpec;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {v0, v1, v2, p2}, Landroidx/media3/datasource/a;->g(Landroid/net/http/HttpEngine;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;

    move-result-object p2

    iget v0, p0, Landroidx/media3/datasource/HttpEngineDataSource;->requestPriority:I

    invoke-static {p2, v0}, Landroidx/media3/datasource/a;->i(Landroid/net/http/UrlRequest$Builder;I)Landroid/net/http/UrlRequest$Builder;

    move-result-object p2

    invoke-static {p2}, Landroidx/media3/datasource/a;->h(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v3, v2}, Landroidx/media3/datasource/a;->s(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Landroidx/media3/datasource/a;->C(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Landroidx/media3/datasource/a;->r(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Landroidx/media3/datasource/a;->A(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0, p1}, Landroidx/media3/datasource/a;->q(Landroid/net/http/UrlRequest$Builder;Landroid/net/http/UploadDataProvider;Ljava/util/concurrent/Executor;)V
...
.method private buildRequestWrapper(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;
    ...
    invoke-static {p1}, Landroidx/media3/datasource/a;->j(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest;
...
.method private static isCompressed(Landroid/net/http/UrlResponseInfo;)Z
    ...
    invoke-static {p0}, Landroidx/media3/datasource/a;->d(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p0

    invoke-static {p0}, Landroidx/media3/datasource/a;->n(Landroid/net/http/HeaderBlock;)Ljava/util/List;
...
.method private skipFully(JLandroidx/media3/datasource/DataSpec;)V
    ...
    :try_start_0
    iget-object v4, p0, Landroidx/media3/datasource/HttpEngineDataSource;->operation:Lk0/g;

    invoke-virtual {v4}, Lk0/g;->d()V
...
.method public getResponseCode()I
    ...
    invoke-static {v0}, Landroidx/media3/datasource/a;->b(Landroid/net/http/UrlResponseInfo;)I
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    :cond_0
    invoke-static {v0}, Landroidx/media3/datasource/a;->d(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/datasource/a;->o(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
...
.method public getUri()Landroid/net/Uri;
    ...
    invoke-static {v0}, Landroidx/media3/datasource/a;->y(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    iget-object v0, v1, Landroidx/media3/datasource/HttpEngineDataSource;->operation:Lk0/g;
    ...
    invoke-static {v0}, Landroidx/media3/datasource/a;->k(Ljava/lang/Object;)Landroid/net/http/UrlResponseInfo;
    ...
    invoke-static {v4}, Landroidx/media3/datasource/a;->o(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    :cond_2
    iget-object v12, v1, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:Lo3/e;
    ...
    invoke-interface {v12, v13}, Lo3/e;->apply(Ljava/lang/Object;)Z
    ...
    invoke-static {v0}, Landroidx/media3/datasource/a;->m(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
...
.method public read(Ljava/nio/ByteBuffer;)I
    ...
    :cond_3
    iget-object v3, p0, Landroidx/media3/datasource/HttpEngineDataSource;->operation:Lk0/g;

    invoke-virtual {v3}, Lk0/g;->d()V
...
.method public read([BII)I
    ...
    iget-object v5, p0, Landroidx/media3/datasource/HttpEngineDataSource;->operation:Lk0/g;

...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput p1, p0, Lr1/G;->b:F

    iput p1, p0, Lr1/G;->c:F

    new-instance p1, Landroid/text/TextPaint;

    invoke-direct {p1}, Landroid/text/TextPaint;-><init>()V

    iput-object p1, p0, Lr1/G;->f:Landroid/text/TextPaint;
    ...
    iput-object p1, p0, Lr1/G;->g:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lr1/G;->h:Landroid/graphics/Paint;
...
.method public final a(Landroid/graphics/Canvas;Z)V
    ...
    iget-object p2, p0, Lr1/G;->E:Landroid/text/StaticLayout;

    iget-object v0, p0, Lr1/G;->F:Landroid/text/StaticLayout;
    ...
    iget v3, p0, Lr1/G;->H:I

    int-to-float v3, v3

    invoke-virtual {p1, v2, v3}, Landroid/graphics/Canvas;->translate(FF)V

    iget v2, p0, Lr1/G;->u:I
    ...
    iget-object v8, p0, Lr1/G;->g:Landroid/graphics/Paint;

    invoke-virtual {v8, v2}, Landroid/graphics/Paint;->setColor(I)V

    iget v2, p0, Lr1/G;->I:I
    ...
    :goto_0
    iget p1, p0, Lr1/G;->w:I

    const/4 v2, 0x0

    const/4 v4, 0x1

    iget-object v5, p0, Lr1/G;->f:Landroid/text/TextPaint;
    ...
    iget v7, p0, Lr1/G;->b:F

    if-ne p1, v6, :cond_3

    iget p1, p0, Lr1/G;->c:F

    iget v0, p0, Lr1/G;->v:I
    ...
    iget-object p1, p0, Lr1/G;->J:Landroid/graphics/Rect;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p1, p0, Lr1/G;->k:Landroid/graphics/Bitmap;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p1, p0, Lr1/G;->k:Landroid/graphics/Bitmap;

    iget-object p2, p0, Lr1/G;->J:Landroid/graphics/Rect;

    iget-object v0, p0, Lr1/G;->h:Landroid/graphics/Paint;

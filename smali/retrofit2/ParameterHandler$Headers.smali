...
.method public bridge synthetic apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lretrofit2/ParameterHandler$Headers;->apply(Lretrofit2/RequestBuilder;Lw5/p;)V

    return-void
.end method

.method public apply(Lretrofit2/RequestBuilder;Lw5/p;)V
    .locals 2

    if-eqz p2, :cond_0

    invoke-virtual {p1, p2}, Lretrofit2/RequestBuilder;->addHeaders(Lw5/p;)V

...
.field private final headers:Lw5/p;
...
.method public constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lw5/r;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lw5/r;
    ...
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lw5/p;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lw5/p;

    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lw5/t;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lw5/t;
...
# virtual methods
.method public create([Ljava/lang/Object;)Lw5/B;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lw5/r;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lw5/p;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lw5/t;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lw5/r;Ljava/lang/String;Lw5/p;Lw5/t;ZZZ)V
    ...
    :cond_1
    invoke-virtual {v3}, Lretrofit2/RequestBuilder;->get()Lw5/A;
    ...
    invoke-virtual {p1, v1, v0}, Lw5/A;->d(Ljava/lang/Class;Ljava/lang/Object;)V
